...
```markdown
用户说："新增一个 Skill：Python 代码规范检查器"
```

#### 步骤 2：AI 自动生成 Skill

AI 自动：
1. 总结 Python 代码规范的最佳实践
2. 创建 `.lingma/skills/python-code-linter.md` 文件
3. 按照标准格式编写（YAML Front Matter + 触发条件 + 核心功能 + 案例）
